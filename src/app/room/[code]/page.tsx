...
export default function RoomPage({
  ...
  async function startAuction() {
    ...
    if (pool.length === 0) {
      alert(
        'Please configure players first! Click "Configure Players" button.',
      );
      return;
    }
    ...
    try {
      ...
      updates[`rooms/${code}/meta/lockedParticipants`] = Object.keys(
                ...
                style={{
                  ...
                  background:
                    uid === user?.uid
                      ...
                      : "rgba(13,34,64,0.5)",
                  border: `1px solid ${
                    uid === user?.uid ? "rgba(212,175,55,0.2)" : "#1a3a5c"
                  }`,
                  borderRadius: 12,
                }}
              >
      ...
      {showPlayerModal && isHost && (
        ...
        >
            ...
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              ...
              <button
                ...
                style={{
                  ...
                  letterSpacing: 2,
                  cursor:
                    selectedPlayerIds.size > 0 ? "pointer" : "not-allowed",
                }}
              >
            ...
            <button
              onClick={() => {
                const marquee = new Set(
                  ALL_PLAYERS.filter((p) => p.basePrice >= 1.0).map(
                    (p) => p.id,
                  ),
                );
          ...
          >
            ...
            />
            {["All", "Batsman", "Bowler", "All-Rounder", "WK-Batsman"].map(
              (r) => (
                <button
                  key={r}
            ...
            {["All", "Indian", "Overseas"].map((n) => (
              <button
                ...
                style={{
                  ...
                  background:
                    natFilter === n ? "rgba(212,175,55,0.15)" : "transparent",
